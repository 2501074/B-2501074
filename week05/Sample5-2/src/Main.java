public class Main {
    public static void main(String[] args) {
        boolean test  = 5 > 3 && 6 < 3;  //ture && false = false;
        boolean test1 = 2 > 3 && 6 < 3; //false && ? = false;

        boolean test2 = 5 > 3 || 6 < 3; //ture || ? = true; short circuit Eval
        boolean test3 = 2 > 3 || 6 < 3; //false || false = false;

        boolean test4 = 5 > 3 && 6 < 3;  //ture && false = false;
        boolean test5 = 2 > 3 && 6 < 3; //false && false = false;

        boolean test6 = 5 > 3 || 6 < 3; //ture || false = true; short circuit Eval
